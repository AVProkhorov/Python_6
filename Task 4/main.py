...
RB  = IntVar()
RB1 = Radiobutton(page2, text="SciPy ODEINT", variable=RB, value=1).pack(anchor=W)
RB2 = Radiobutton(page2, text="Verlet", variable=RB, value=2).pack(anchor=W)
RB3 = Radiobutton(page2, text="Verlet + Multithreading", variable=RB, value=3).pack(anchor=W)
RB.set(1)
time_size_v = DoubleVar()
time_size_v.set(1000)
time_size = Entry(page2, bg='white', textvariable=time_size_v).pack(anchor=W)
exec_button = Button(page2, text='Execute method', command=exec_method).pack(anchor=W)
